...
public:
	GameObject(Mesh* mesh, Shader* shader, InputController* input, Vector3 position,int id);
	GameObject(Mesh* mesh, Shader* shader, InputController* input, Vector3 position, Texture* texture, int id);
	~GameObject();
