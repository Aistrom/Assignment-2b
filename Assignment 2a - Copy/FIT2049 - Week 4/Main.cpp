...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR pScmdline, int iCmdshow)
{
	...
	Window* win = new Window("FIT2096 Assignment 1: Simple Game implementation", 1280, 720, false);	//We'll create our window object, set a size and if we want it fullscreen
